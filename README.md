...
Размер Kaggle датасета составляет ~140 картинок, размер собранного нами датасет составляет ~130 картинок, итого из реальеых данных для обучения, валидации, и теста модели используется ~270 картинок.  
...
Результаты на тесте:  
![raw_exp](./assets/finale/wrong_data.png)

После чего была проведена чистка данных. Метрики на тесте: ![raw_exp](./assets/finale/cleaned_data.png)
...
![raw_exp](./assets/finale/raw_exp.png)
...
![10_exp](./assets/finale/10_prec_synth.png)
...
Метрики:
![final_metrics](./assets/finale/finale_metrics.png)
